//Refer to https://geohackweek.github.io/GoogleEarthEngine/ for proper explanation of the code
...
var setExtent = watershedBoundaries.filterMetadata('name', 'equals', 'Republican');
...
Map.addLayer(annualGreenest.select('GI_max_14'), 
